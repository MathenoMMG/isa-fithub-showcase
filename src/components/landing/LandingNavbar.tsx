...
import { ShieldCheck, LogIn, ArrowRight, Sun, Moon, Sparkles, Store, Lock } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="h-11 w-11 rounded-2xl bg-emerald-700 dark:bg-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-700/20 group-hover:scale-105 transition-transform overflow-hidden p-1.5 border border-emerald-500/30">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600 dark:text-slate-300">
          ...
          <a href="#sucursales" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
            Sucursales
          </a>
