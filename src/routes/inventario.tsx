  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col xl:flex-row gap-3 items-start xl:items-center w-full">
        <div className="flex flex-col sm:flex-row gap-3 items-center w-full xl:w-auto flex-1">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" className="h-12 w-full sm:w-auto border-dashed bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-800 text-slate-700 dark:text-slate-200 rounded-xl shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto xl:ml-auto shrink-0 xl:border-l xl:border-slate-200 dark:border-slate-800 xl:pl-3 pt-3 xl:pt-0 border-t xl:border-t-0 border-slate-200">
          <Button 
            variant="ghost" 
            className="flex-1 sm:flex-none h-12 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-800 xl:border-0"
